...
const MetaCallback = () => {
  ...
  useEffect(() => {
    const handleCallback = async () => {
      ...
      if (!code) {
        setStatus("error");
        setErrorMessage("No se recibió código de autorización de Meta");
        setTimeout(() => navigate("/connections"), 3000);
        return;
      }
      ...
      try {
        ...
        // Success!
        setStatus("success");
        toast.success(`✅ Cuenta vinculada correctamente. ${result.accountsCount || 0} cuenta(s) detectadas.`);
      ...
      <div className="glass rounded-xl p-8 max-w-md w-full mx-4 text-center">
        {status === "processing" && (
          <>
            ...
            <p className="text-muted-foreground">
              Estamos validando tu autorización y obteniendo acceso a tus cuentas.
            </p>
          </>
        )}
        ...
        {status === "success" && (
          <>
            ...
            <p className="text-muted-foreground">
              Tu cuenta de Meta Ads ha sido vinculada correctamente. Redirigiendo...
            </p>
          </>
        )}
